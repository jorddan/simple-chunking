...
#include "external/blake3/blake3_portable.c"
...
#include "external/blake3/blake3_sse2.c"
...
#endif
#include "external/blake3/blake3_sse41.c"
#if defined(__clang__)
...
#endif
#include "external/blake3/blake3_avx2.c"
#if defined(__clang__)
#pragma clang attribute pop
#endif
...
#endif
#include "external/blake3/blake3_avx512.c"
#if defined(__clang__)
#pragma clang attribute pop
#endif
...
#include "external/blake3/blake3_neon.c"
#endif

#include "external/blake3/blake3_dispatch.c"
#include "external/blake3/blake3.c"
